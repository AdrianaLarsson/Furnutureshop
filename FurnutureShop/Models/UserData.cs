...
namespace FurnutureShop.Models
{
    ...
    public static List<UserData> GetUsers()

        {
            ...
            UserList.Add(new UserData { Id = 1, Email = "micke@primat.se", Password = "hejsan", Name = "Mikael Engström" });
            UserList.Add(new UserData { Id = 2, Email = "adrianalarsson@primat.se", Password = "adriana", Name = "Adriana" });
            return UserList;
        }
public class Cart
{
